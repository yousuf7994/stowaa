          ...
          <div class="account_content_area">
            ...
            <ul class="content_layout ul_li_block">
              <li>
                ...
                <p class="mb-0">From your My Account Dashboard you have the ability to view a snapshot of your recent
                  account activity and update your account information. Select a link below to view or edit information.
                </p>
              </li>
              <li>
